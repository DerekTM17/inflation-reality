            ...
            <div style={{ background: "#fff", borderRadius: 10, border: "1px solid #e0e0e0", padding: 24, marginTop: 20 }}>
              ...
              <div className="ir-grid-2" style={{ display: "grid", gap: "12px 24px" }}>
                {[
                  ...
                  { term: "Trimmed-Mean PCE", def: "The Dallas Fed's trimmed-mean measure applied to PCE (the Fed's preferred index) rather than CPI — it drops the most extreme price moves on each side to reveal the underlying trend." },
